<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="name" value="{{ __('RUC') }}" />
                <x-jet-input id="name" class="block w-full mt-1" type="text" name="ruc" :value="old('ruc')" required autofocus autocomplete="ruc" />
            </div>

            <div class="mt-4">
                <x-jet-label for="name" value="{{ __('Razón Social') }}" />
                <x-jet-input id="name" class="block w-full mt-1" type="text" name="razonsocial" :value="old('razonsocial')" required autofocus autocomplete="razonsocial" />
            </div>
