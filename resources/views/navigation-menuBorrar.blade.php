    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('admin.showtables') }}" :active="request()->routeIs('admin.showtables')">
                        {{ __('Tablas') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('comprobante.list') }}" :active="request()->routeIs('comprobante.list')">
                        {{ __('Ventas') }}
                    </x-jet-nav-link>
                </div>
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        ...
                                        {{ Auth::user()->name }} ( {{ Auth::user()->employee->local->address }} )
