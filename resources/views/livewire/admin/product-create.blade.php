        ...
        <div class="px-3 py-4 bg-white md:col-span-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
                ...
                <div class="gap-0 sm:col-span-1 lg:col-span-3">
                    <div class="mr-1">
                        ...
                        <x-jet-input type="text" wire:model="name" class="w-full h-10 uppercase" />
                        <x-jet-input-error for="name" />
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2">
                ...
                <div class="mr-2">
                    ...
                    <div class="box-border p-4 mb-4 border-2 rounded-md">
                        ...
                        <input type="file" wire:model="image1" accept="image/*" {{-- id="{{ $identificador }}" --}}>
                ...
                <div class="mr-2">
                    ...
                    <div class="box-border p-4 mb-4 border-2 rounded-md">
                        ...
                        {{-- <input type="file" wire:model="brand.image" id="{{ $identificador }}"> --}}
                        <input type="file" wire:model="image2" accept="image/*" {{-- id="{{ $identificador }}" --}}>
                        {{-- borramos accept="image/*" --}}
                ...
                <div class="mr-2">
                    ...
                    <div class="box-border p-4 mb-4 border-2 rounded-md">
                        ...
                        {{-- <input type="file" wire:model="brand.image" id="{{ $identificador }}"> --}}
                        <input type="file" wire:model="image3" accept="image/*" {{-- id="{{ $identificador }}" --}}>
                        {{-- borramos accept="image/*" --}}
                ...
                <div>
                    ...
                    <div class="box-border p-4 mb-4 border-2 rounded-md">
                        ...
                        {{-- <input type="file" wire:model="brand.image" id="{{ $identificador }}"> --}}
                        <input type="file" wire:model="image4" accept="image/*" {{-- id="{{ $identificador }}" --}}>
                        {{-- borramos accept="image/*" --}}
            ...
            <div class="w-full px-4 mt-6 mb-4">
                ...
                <x-jet-danger-button wire:click="save">
                    <i class="mx-2 fa-regular fa-floppy-disk"></i> {{ __('Crear Producto') }}
                    </x-jet-button>
