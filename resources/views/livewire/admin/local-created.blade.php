            ...
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                ...
                <div class="flex flex-wrap mx-4 mt-4">
                    <div class="w-full px-4 mb-4 md:w-4/4">
                        ...
                        <x-jet-input type="text" class="w-full uppercase" wire:model.defer="name" />
                        <x-jet-input-error for="name" />
                    </div>

                    <div class="w-full px-4 mb-4 md:w-1/2">
                        <x-jet-label value="Dirección" />
                        <x-jet-input type="text" class="w-full uppercase" wire:model.defer="address" />
                        <x-jet-input-error for="address" />
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/2">
                        <x-jet-label value="Email" />
                        <x-jet-input type="email" class="w-full lowercase" wire:model.defer="email" />
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        ...
                        <x-jet-input type="text" class="w-full uppercase" wire:model.defer="phone" />
                        <x-jet-input-error for="phone" />
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <x-jet-label value="Celular" />
                        <x-jet-input type="text" class="w-full uppercase" wire:model.defer="movil" />
                        <x-jet-input-error for="movil" />
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <x-jet-label value="Anexo" />
                        <x-jet-input type="text" class="w-full uppercase" wire:model.defer="anexo" />
                        <x-jet-input-error for="anexo" />
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <x-jet-label value="Estado" />
                        <x-jet-input type="checkbox" wire:model.defer="state" />
