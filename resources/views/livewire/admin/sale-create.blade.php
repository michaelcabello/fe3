            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div>
                        ...
                        <h3 class="mt-2 mb-5 text-center underline">Nueva Venta</h3>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 lg:grid-cols-6">
                            ...
                            <div class="mb-4 mr-4 ">
                                ...
                                <select wire:model="tipocomprobante_id"
                                    ...
                                    @foreach ($tipocomprobantes as $tipocomprobante)
                                        <option value="{{ $tipocomprobante->id }}">{{ $tipocomprobante->name }}</option>
                                    @endforeach
                            ...
                            <div class="mb-4 mr-4">
                                ...
                                <x-jet-input id="datepicker2" type="text" wire:model="fechavencimiento"
                                    value="{{ old('fechavencimiento') }}" placeholder="fecha de pago" class="w-full" />
