...
<head>
    ...
    <title>Edon – Fashion Store Bootstrap 5</title>
    ...
    <meta property="og:title" content="Edon – Fashion Store Bootstrap 5 Template" />
...
<body>
                    ...
                    <div class="offcanvas_menu_wrapper">
                        ...
                        <div class="header_contact_info">
                            <ul class="d-flex">
                                ...
                                <li class="text-white"> <i class="icon-envelope-letter icons"></i> <a href="#">Edonstore@domain.com</a></li>
                            </ul>
                        </div>
    ...
    <header class="header_section">
        <div class="header_top">
            <div class="container custom-space">
                <div class="row">
                    <div class="col-12">
                        <div class="header_top_inner d-flex justify-content-between align-items-sm-center">
                            <div class="header_contact_info">
                                <ul class="d-flex">
                                    <li class="text-white"> <i class="icons icon-phone"></i> <a href="tel:+05483716566">+054 8371 65 66</a></li>
                                    <li class="text-white"> <i class="icon-envelope-letter icons"></i> <a href="#">Edonstore@domain.com</a></li>
                            ...
                            <div class="with-canvas">
                                <div class="header_account">
                                    <ul class="d-flex">
                                        ...
                                        <li><a href="wishlist.html"><i class="icon-heart icons"></i></a> <span class="item_count">2</span></li>
    ...
    <!--footer area start-->
    <footer class="footer_widgets pb-90">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-sm-7">
                    <div class="footer_widget_list text-end">
                        ...
                        <div class="copyright_right">
                            <p>© 2022 Edon - All Rights Reserved. </p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="modal_right">
                                    <div class="mb-10 modal_title">
                                        <h2>Donec Ac Tempus</h2>
                                    </div>
                                    <div class="mb-10 modal_price">
                                        <span class="new_price">$64.99</span>
                                        <span class="old_price" >$78.99</span>
                                    </div>
                                    <div class="modal_description mb-15">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Duis sed malesuada diam. Fusce sapien est, fringilla sit amet tortor vel, facilisis maximus nulla.</p>
                                    </div>
